...
import { type BatchPostingExecutor, type ImportLockAdapter, type ImportRequest, type ImportSettings, type MandateLink, type ImportBatchResponse } from './import-batch.js';
export type EmailArchiveStatus = 'archived' | 'move_failed' | 'not_attempted' | 'provider_not_available' | 'email_not_found' | (`error: ${string}` & {});
...
export declare function importGocardlessBatchFromEmail(operaDb: Knex, appDb: Knex, input: ImportFromEmailRequest, settings: ImportSettings, knownMandates: MandateLink[], executor: BatchPostingExecutor, importLock: ImportLockAdapter, archiveAdapter: EmailArchiveAdapter | null): Promise<ImportFromEmailResponse>;
//# sourceMappingURL=import-from-email.d.ts.map